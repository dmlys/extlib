...
namespace
{
	...
	struct CodecvtFixture
	{
		...
		void ReadFiles()
		{
			...
			ext::LoadFile("ExtLibrary/tests/CodecvtConvTestFiles/Martin_ru_utf8.txt", martin_ru_utf8, std::ios::binary);
			ext::LoadFile("ExtLibrary/tests/CodecvtConvTestFiles/Martin_ru_cp1251.txt", martin_ru_cp1251, std::ios::binary);

			std::wifstream ifs("ExtLibrary/tests/CodecvtConvTestFiles/Martin_ru_utf16LE.txt", std::ios::binary);
			ifs >> std::noskipws;
